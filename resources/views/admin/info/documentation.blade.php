...
<div class="bg-white p-5 m-5 rounded-lg">
    ...
    <table class="w-full bg-white border border-gray-200">
        <thead class="bg-gray-200 text-gray-700 text-sm uppercase font-semibold text-left">
            <tr>
                <th class="py-3 px-4 font-semibold text-sm w-5">časti </th>
        ...
        <tbody class="text-gray-600">
            <tr>
                <td class="py-3 px-4 border border-gray-200">matematicka</td>
            ...
            <tr>
                <td class="py-3 px-4 border border-gray-200">obrázok</td>
                <td class="py-3 px-4 border border-gray-200 text-center">javascript</td>
            </tr>
            <tr>
                <td class="py-3 px-4 border border-gray-200">Ikony</td>
